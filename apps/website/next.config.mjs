...
const nextConfig = {
  ...
  transpilePackages: ['@leaksync/ui', '@leaksync/core'],
  webpack: (config) => {
    config.resolve.alias = {
      ...(config.resolve.alias ?? {}),
      '@leaksync/ui': path.resolve(__dirname, '../../packages/ui/src/index.ts'),
      '@leaksync/core': path.resolve(__dirname, '../../packages/core/src/index.ts'),
