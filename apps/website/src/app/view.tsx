...
export function HomeView() {
  ...
  return (
    <div
      ref={rootRef}
      className="min-h-screen overflow-x-hidden bg-[#fff6e9] text-[#221d3a]"
    >
      {/* ===== Full-viewport hero ===== */}
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col items-center justify-center px-5 py-12 text-center sm:px-8">
          ...
          <div data-hero-rest className="flex w-full flex-col items-center">
            <p className="mt-7 max-w-xl text-[16px] leading-relaxed text-[#221d3a]/70 sm:text-[18px]">
              LeakSync sits in your Android share sheet. Tap it, hear the ding
              on your Mac, paste. No accounts, no cables, no emailing yourself.
            </p>
            <Link
              href="/download"
            ...
            <p className="mt-10 text-[13px] font-semibold text-[#221d3a]/45">
              Pairs with a 6-digit code in 2 seconds.
            </p>
          </div>
        </div>
      ...
      >
          ...
          <div className="rounded-3xl bg-[#221d3a] p-4 shadow-[0_24px_60px_rgba(34,29,58,0.3)] sm:p-5">
            <div className="h-44 rounded-2xl bg-gradient-to-br from-[#3a3360] to-[#221d3a] p-4">
              ...
              >
                ...
                <p className="mt-2 text-[10px] font-bold text-[#2b50c8]">
                  Click to copy
                </p>
              </div>
            </div>
        ...
        <div data-ding-copy>
          <h2 className="text-[clamp(30px,4.4vw,50px)] font-extrabold leading-tight tracking-[-0.02em]">
            The <span className="text-[#ff6b4a]">ding</span> is the whole
            product.
          </h2>
          <p className="mt-5 max-w-lg text-[16px] leading-relaxed text-[#221d3a]/70 sm:text-[17px]">
            You tap share on the phone and your Mac chimes before you put the
            phone down. Click the menu bar to copy it, or drag it straight into
            Slack, Notes, or an email draft.
          </p>
          <p className="mt-4 max-w-lg text-[16px] leading-relaxed text-[#221d3a]/70 sm:text-[17px]">
            Everything deletes itself from the server after 24 hours. Nothing
            piles up, nothing to manage.
          </p>
        </div>
      </section>
      ...
      <section
        data-ritual
        className="border-y-2 border-[#221d3a]/8 bg-[#fffbf3]"
      >
        <div className="mx-auto grid w-full max-w-7xl items-center gap-10 px-5 py-20 sm:px-8 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 max-w-md text-[16px] leading-relaxed text-[#221d3a]/70">
              Apple keeps Continuity for Apple phones. So everything you spot on
              your Android takes the long way to your Mac. Many times a day.
            </p>
          </div>
        ...
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {STEPS.map((step, i) => (
              ...
              >
                <span className="text-[30px] font-extrabold opacity-50">
                  0{i + 1}
                </span>
      ...
      >
        ...
        <p className="mx-auto mt-4 max-w-md text-center text-[15px] text-[#221d3a]/60">
          From Twitter, Chrome, Photos, WhatsApp, Notes, anywhere with a share
          button.
        </p>
          ...
          <div className="mt-12 space-y-3">
            {FAQ.map((item) => (
              ...
              >
                ...
                <p className="mt-3 text-[14.5px] leading-relaxed text-[#221d3a]/70">
                  {item.a}
                </p>
              </details>
            ))}
  ...
  return (
    <div className="overflow-hidden">
      <div
        ...
        style={
          {
            "--marquee-duration": reverse ? "34s" : "26s",
